...
describe('Caching Strategy (e2e)', () => {
    ...
    describe('GET /pokemons (Caching)', () => {
        ...
        it('should support ETag (304 Not Modified)', async () => {
            ...
            const response1 = await request(app.getHttpServer()).get('/pokemons');
    ...
    describe('Invalidation', () => {
        it('should invalidate cache on mutation (POST/DELETE)', async () => {
            ...
            await request(app.getHttpServer()).get('/pokemons');
            ...
            // Cleanup
            await request(app.getHttpServer()).delete('/pokemons/9999');
        });
    });
});
