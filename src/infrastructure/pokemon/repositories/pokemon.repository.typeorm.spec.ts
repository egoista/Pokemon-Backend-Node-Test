...
describe('PokemonRepositoryTypeORM', () => {
  ...
  describe('findById', () => {
    ...
    it('should map empty types when entity has no relations loaded', async () => {
      ...
      await expect(repository.findById(2)).rejects.toThrow(
      ...
      const mockEntities: PokemonEntity[] = [
        {
          ...
          name: 'Bulbasaur',
          types: [
            { id: 1, name: 'Grass', created_at: new Date(), pokemons: [] },
          ],
          created_at: new Date(),
        },
        {
  ...
  describe('findWithFilters', () => {
    ...
    beforeEach(() => {
      ...
      mockPokemonRepository.createQueryBuilder.mockReturnValue(
        mockQueryBuilder,
      );
    });
      ...
      const mockEntities: PokemonEntity[] = [
        {
          ...
          name: 'Charmander',
          types: [
            { id: 2, name: 'Fire', created_at: new Date(), pokemons: [] },
          ],
          created_at: new Date(),
        },
      ];
  ...
  describe('save', () => {
    ...
    it('should resolve and create new types if they do not exist', async () => {
      ...
      expect(mockTypeRepository.create).toHaveBeenCalledWith({
        name: 'NewType',
      });
  ...
  describe('delete', () => {
    it('should delete Pokemon by ID', async () => {
      mockPokemonRepository.delete.mockResolvedValue({
        affected: 1,
        raw: {},
      } as any);
